 ...
 * Consulta
 */
$consulta = "SELECT * FROM `euromillon_sorteos` ORDER BY `fecha` DESC limit 10";//Para que coja solo el ultimo mes
 ...
 */
/*if ($debug){
$conectadoDesde = "Debug";
print_r($numeros5GanadoresFinal);
echo "<br>";
print_r($estrellas2GanadoresFinal);
echo "<br>";
}*/
/**
